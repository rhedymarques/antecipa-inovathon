# Documentação do Antecipa

[← Voltar à apresentação do projeto](../README.md)

| Quero… | Onde começar |
| --- | --- |
| Entender o problema e a proposta para o desafio Cielo. | [Proposta e evolução](PROPOSTA.md) |
...
Os [registros de implementação](../HANDOFF.md) preservam decisões e verificações anteriores. Todos os exemplos usam dados sintéticos, sem integração ou execução financeira.
